...
plot_parser.add_argument('--model', default='main_dnn.h5')
...
plot_parser.add_argument('--CL', type=float, default=0.68)
plot_parser.add_argument('--mdn', default=False, action='store_true')
